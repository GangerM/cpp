...
class BST {
 ...
 private:
	...
	void RightRight(std::shared_ptr<BSTNode> currentNode);
	void LeftLeft(std::shared_ptr<BSTNode> currentNode);
	void RightLeft(std::shared_ptr<BSTNode> currentNode);
	void LeftRight(std::shared_ptr<BSTNode> currentNode);

	int Height(std::shared_ptr<BSTNode> currentNode);
	int BalanceFactor(std::shared_ptr<BSTNode> currentNode);
